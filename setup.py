...
setuptools.setup(
    ...
    python_requires='>=3.6',
    install_requires=['numpy', 'pandas', 'joblib', 'flask', 'flask_cors', 'google-cloud-storage', 'gcsfs', 'fsspec', 'gunicorn', 'trachoma @ git+https://github.com/ArtRabbitStudio/ntd-model-trachoma.git@develop'],
